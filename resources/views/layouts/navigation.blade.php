<nav x-data="{ open: false }" class="bg-gray-900 text-gray-200 border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        <x-nav-link :href="route('static.home')" :active="request()->routeIs('other.*')">
                            <i class="fa-solid fa-link mr-1"></i>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-gray-200">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                <x-responsive-nav-link :href="route('static.dashboard')"
                                       :active="request()->routeIs('static.dashboard')">
                    <i class="fa-solid fa-laptop mr-1"></i>
                    {{ __('Dashboard') }}
                </x-responsive-nav-link>
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('static.home')" :active="request()->routeIs('other.*')">
                    <i class="fa-solid fa-link mr-1"></i>
                    {{ __('Other Links') }} ({{ __('Unauthenticated') }})
                </x-responsive-nav-link>
